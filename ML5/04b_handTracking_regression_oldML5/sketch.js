...
function drawResults() {
	...
	textAlign(LEFT);
	let ty = 20;
	text("Step 1: Create a fist, set training value to 0 with mouse, press Space to add samples.", 10, ty += 15);
	text("Step 2: Open palm, set training value to 1 with mouse, press Space to add samples.", 10, ty += 15);
